from src.accountmatchlist import AccountMatchList
from src.championData import ChampionData
from src.MatchDetailsList import MatchDetailsList
...
# compare against my games

# pull all data from lol api for my aram games
matches = AccountMatchList()

full_match_details = MatchDetailsList(matches)

print(full_match_details)

# match details should contain:


# find average score for each team in each game using champion_data

# compare wins/champion score